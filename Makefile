...
TARGET=exercicio_refatoracao

BUILD_DIR = ./build
SRC_DIR = ./src
INCLUDE_DIR = ./include

all=exercicio_refatoracao
...
${BUILD_DIR}/main.o: ${INCLUDE_DIR}/Casa.hpp ${INCLUDE_DIR}/Cliente.hpp ${INCLUDE_DIR}/Apartamento.hpp ${INCLUDE_DIR}/Cobertura.hpp ${INCLUDE_DIR}/Imovel.hpp ${SRC_DIR}/main.cpp
