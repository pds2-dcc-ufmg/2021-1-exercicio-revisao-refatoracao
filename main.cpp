...
int main() {
    ...
    ap1.valor = ap1.ValorVenda() + ap1.comissao();
    ap1.vendedor = cl1;
    qtdeA++;
    ...
    ap2.valor = ap2.ValorVenda() + ap2.comissao();
    ap2.vendedor = cl2;
    qtdeA++;
    ...
    ap3.valor = ap3.ValorVenda() + ap3.comissao();
    ap3.vendedor = cl3;
    qtdeA++;
    ...
    cb1.valor = cb1.ValorVenda() + cb1.comissao();
    cb1.vendedor = cl4;
    qtdeCb++;
    ...
    cb2.valor = cb2.ValorVenda() + cb2.comissao();
    cb2.vendedor = cl5;
    qtdeCb++;
    ...
    cb3.valor = cb3.ValorVenda() + cb3.comissao();
    cb3.vendedor = cl6;
    qtdeCb++;
    ...
    ca1.valor = ca1.ValorVenda() + ca1.comissao();
    ca1.vendedor = cl7;
    qtdeCa++;
    ...
    ca2.valor = ca2.ValorVenda() + ca2.comissao();
    ca2.vendedor = cl8;
    qtdeCa++;
