...
int main() {
    ...
    Apartamento ap1 = Apartamento("Tuoruars", 55.4, 2, 1, 0, 987.0, cl1); qtdeA++;
    Apartamento ap2 = Apartamento("Fyubyeis", 74.5, 2, 1, 2, 1540.0, cl2); qtdeA++;
    Apartamento ap3 = Apartamento("Kelia", 87.2, 3, 2, 2, 2354.0, cl3); qtdeA++;

    // Cobertura
    Cobertura cb1 = Cobertura("Koci", 120.1, 3, 3, 2, 3123.5, cl4); qtdeCb++;
    Cobertura cb2 = Cobertura("Wail", 134.8, 4, 3, 3, 3578.2, cl5); qtdeCb++;
    Cobertura cb3 = Cobertura("Fival", 180.0, 4, 4, 4, 4165.7, cl6); qtdeCb++;
    

    // Casas
    Casa ca1 = Casa("Beydo", 145.6, 3, 3, 2, 4023.6, cl7); qtdeCa++;
    Casa ca2 = Casa("Riuzi", 245.0, 5, 4, 4, 4856.2, cl8); qtdeCa++;
