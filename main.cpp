...
int main() {
	...
	//Imoveis para inicializar
    int qtdeA = 0;
    int qtdeCa = 0;
    int qtdeCb = 0;

	//Apartamentos inicializados
    Apartamento ap1;
    ...
    ap3.vagas = 2;
    ap3.valor_m2 = 2354.0;
    ap3.valor_com = ap3.comissao();
    ap3.valor_venda = ap3.valor() + ap3.comissao();
    ap3.vendedor = cl3;
    qtdeA++;

    // Coberturas inicializadas
    Cobertura cb1;
    cb1.corretor = "Koci";
    cb1.area = 120.1;
    cb1.quartos = 3;
	...
	//inicializa como zero para evitar erros
    double valorAp = 0.0;
    double valorCb = 0.0;
    double valorCa = 0.0;
    double comissAp = 0.0;
    ...
    //Print de dados dos imoveis e valores deles e das comissoes
    ap1.print();
    valorAp += ap1.valor();
	...
	//Parte que apresenta os dados de quantidade de imoveis, valor e comissao
    std::cout << "\n>> Resumo Geral <<" << endl;
