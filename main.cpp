...
int main() {
    ...
    ap1.ValorFinal = ap1.valor() + ap1.comissao();
    ap1.vendedor = cl1;
    qtdeA++;
    ...
    ap2.ValorFinal = ap2.valor() + ap2.comissao();
    ap2.vendedor = cl2;
    qtdeA++;
    ...
    ap3.ValorFinal = ap3.valor() + ap3.comissao();
    ap3.vendedor = cl3;
    qtdeA++;
    ...
    cb1.ValorFinal = cb1.valor() + cb1.comissao();
    cb1.vendedor = cl4;
    qtdeCb++;
    ...
    cb2.ValorFinal = cb2.valor() + cb2.comissao();
    cb2.vendedor = cl5;
    qtdeCb++;
    ...
    cb3.ValorFinal = cb3.valor() + cb3.comissao();
    cb3.vendedor = cl6;
    qtdeCb++;
    ...
    ca1.ValorFinal = ca1.valor() + ca1.comissao();
    ca1.vendedor = cl7;
    qtdeCa++;
    ...
    ca2.ValorFinal = ca2.valor() + ca2.comissao();
    ca2.vendedor = cl8;
    qtdeCa++;
