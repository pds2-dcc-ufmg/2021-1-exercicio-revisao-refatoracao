...
int main()
{
    ...
    //Variaveis de quantidade do tipo de imovel
    int qtdeA = 0;
    int qtdeCa = 0;
    int qtdeCb = 0;

    //Declarando apartamentos
    Apartamento ap1("Tuoruars", 55.4, 987.0, 2, 1, 0, cl1);
    qtdeA++;

    Apartamento ap2("Fyubyeis", 74.5, 1540.0, 2, 1, 2, cl2);
    qtdeA++;

    Apartamento ap3("Kelia", 87.2, 2354.0, 3, 2, 2, cl3);
    qtdeA++;
    
    // Declarando Coberturas

    Cobertura cb1("Koci", 120.1, 3123.5, 3, 3, 2, cl4);
    qtdeCb++;

    Cobertura cb2("WCbil", 134.8, 3578.2, 4, 3, 3, cl5);
    qtdeCb++;

    Cobertura cb3("Fival", 180.0, 4165.7, 4, 4, 4, cl6);
    qtdeCb++;

    // Declarando casas

    Casa ca1("Beydo", 145.6, 4023.6, 3, 3, 2, cl7);
    qtdeCa++;

    Casa ca2("Riuzi", 245.0, 4856.2, 5, 4, 4, cl8);
    qtdeCa++;
