...
int main() {
    ...
    ap1.valor = ap1.valor_ap() + ap1.comissao();
    ap1.vendedor = cl1;
    qtdeA++;
    ...
    ap2.valor = ap2.valor_ap() + ap2.comissao();
    ap2.vendedor = cl2;
    qtdeA++;
    ...
    ap3.valor = ap3.valor_ap() + ap3.comissao();
    ap3.vendedor = cl3;
    qtdeA++;
    ...
    cb1.valor = cb1.valor_cobertura() + cb1.comissao();
    cb1.vendedor = cl4;
    qtdeCb++;
    ...
    cb2.valor = cb2.valor_cobertura() + cb2.comissao();
    cb2.vendedor = cl5;
    qtdeCb++;
    ...
    cb3.valor = cb3.valor_cobertura() + cb3.comissao();
    cb3.vendedor = cl6;
    qtdeCb++;
    ...
    ca1.valor = ca1.valor_casa() + ca1.comissao();
    ca1.vendedor = cl7;
    qtdeCa++;
    ...
    ca2.valor = ca2.valor_casa() + ca2.comissao();
    ca2.vendedor = cl8;
    qtdeCa++;
    ...
    ap1.print();
    valorAp += ap1.valor_ap();
    comissAp += ap1.comissao();
    std::cout << endl;

    ap2.print();
    valorAp += ap2.valor_ap();
    comissAp += ap2.comissao();
    std::cout << endl;

    ap3.print();
    valorAp += ap3.valor_ap();
    comissAp += ap3.comissao();
    std::cout << endl;

    cb1.print();
    valorCb += cb1.valor_cobertura();
    comissCb += cb1.comissao();
    std::cout << endl;

    cb2.print();
    valorCb += cb2.valor_cobertura();
    comissCb += cb2.comissao();
    std::cout << endl;

    cb3.print();
    valorCb += cb3.valor_cobertura();
    comissCb += cb3.comissao();
    std::cout << endl;

    ca1.print();
    valorCa += ca1.valor_casa();
    comissCa += ca1.comissao();
    std::cout << endl;

    ca2.print();
    valorCa += ca2.valor_casa();
