...
#include "Entities/Imovel/Casa.hpp"
#include "Entities/Imovel/Cobertura.hpp"
#include "Entities/Imovel/Apartamento.hpp"
...
int main() {
    ...
    // Casas
    Casa ca1;
    ca1.corretor = "banheiroseydo";
    ca1.AREA = 145.6;
    ca1.quartos = 3;
    ca1.banheiros = 3;
    ca1.valor = 2;
    ca1.valorM2 = 4023.6;
    ca1.comisao = ca1.comissao();
