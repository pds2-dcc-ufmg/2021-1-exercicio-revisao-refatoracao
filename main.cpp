...
int main() {
    ...
    ap1.Vagas = 0;
    ap1.VALORm2 = 987.0;
    ap1.ComissaoValor = ap1.comissao();
    ...
    ap2.Vagas = 2;
    ap2.VALORm2 = 1540.0;
    ap2.ComissaoValor = ap2.comissao();
    ...
    ap3.Vagas = 2;
    ap3.VALORm2 = 2354.0;
    ap3.ComissaoValor = ap3.comissao();
    ...
    cb1.Vagas = 2;
    cb1.VALORm2 = 3123.5;
    cb1.ComissaoValor = cb1.comissao();
    ...
    cb2.Vagas = 3;
    cb2.VALORm2 = 3578.2;
    cb2.ComissaoValor = cb2.comissao();
    ...
    cb3.Vagas = 4;
    cb3.VALORm2 = 4165.7;
    cb3.ComissaoValor = cb3.comissao();
    ...
    ca1.Vagas = 2;
    ca1.VALORm2 = 4023.6;
    ca1.ComissaoValor = ca1.comissao();
    ...
    ca2.Vagas = 4;
    ca2.VALORm2 = 4856.2;
    ca2.ComissaoValor = ca2.comissao();
