...
int main() {
    ...
    ap1.VALOR_TOTAL = ap1.valor_imovel() + ap1.comissao();
    ap1.vendedor = cl1;
    qtdeA++;
    ...
    ap2.VALOR_TOTAL = ap2.valor_imovel() + ap2.comissao();
    ap2.vendedor = cl2;
    qtdeA++;
    ...
    ap3.VALOR_TOTAL = ap3.valor_imovel() + ap3.comissao();
    ap3.vendedor = cl3;
    qtdeA++;
    ...
    cb1.VALOR_TOTAL = cb1.valor_imovel() + cb1.comissao();
    cb1.vendedor = cl4;
    qtdeCb++;
    ...
    cb2.VALOR_TOTAL = cb2.valor_imovel() + cb2.comissao();
    cb2.vendedor = cl5;
    qtdeCb++;
    ...
    cb3.VALOR_TOTAL = cb3.valor_imovel() + cb3.comissao();
    cb3.vendedor = cl6;
    qtdeCb++;
    ...
    ca1.VALOR_TOTAL = ca1.valor_imovel() + ca1.comissao();
    ca1.vendedor = cl7;
    qtdeCa++;
    ...
    ca2.VALOR_TOTAL = ca2.valor_imovel() + ca2.comissao();
    ca2.vendedor = cl8;
    qtdeCa++;
    ...
    cb1.print();
    valorCb += cb1.valor_imovel();
    comissCb += cb1.comissao();
    std::cout << endl;

    cb2.print();
    valorCb += cb2.valor_imovel();
    comissCb += cb2.comissao();
    std::cout << endl;

    cb3.print();
    valorCb += cb3.valor_imovel();
    comissCb += cb3.comissao();
    std::cout << endl;

    ca1.print();
    valorCa += ca1.valor_imovel();
    comissCa += ca1.comissao();
    std::cout << endl;

    ca2.print();
    valorCa += ca2.valor_imovel();
